...
import {img_vitanur} from "../../../contants"

function Footer() {
  return (
     <div className='container mx-auto px-10 lg-px-24'>
       <div className='flex justify-center'>
       <img src={img_vitanur} alt="img" 
         className= 'w-[295px]'
        />
       </div>
     <div className='grid grid-cols-1 md:grid-cols-4 gap-10 text-center md:text-left py-10 font-serif 
     ...
     <ul>
      ...
      <ul>
        ...
        <li><Link>+ 1 (617) 249-4176</Link></li>
